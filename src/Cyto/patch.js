...
const hashDiff = (a, b) => eitherIsNil(a, b) || a.hash() !== b.hash();

const shallowObjDiff = (a, b) => {
...
const atKey = (obj, key) => (obj !== null ? obj[key] : null);
...
const patchStyle = (cy, style1, style2, toJson) => {
  cy.style().fromJson(toJson(style2)).update();
};

export const patchElements = (cy, eles1, eles2, toJson, get, forEach, diff) => {
  const toAdd = [];
